...
class Training:
    ...
    def prepare_dataset_for_train_valid(self):
        ...
        X_train, X_valid, y_train, y_valid = train_test_split(X_train, y_train, test_size=0.2, random_state=2018, stratify=y_train)
    ...
    def train(self):
        ...
        X_train, X_valid, X_test, y_train, y_valid, y_test = self.prepare_dataset_for_train_valid()
        ...
        dataset_valid = TensorDataset(torch.LongTensor(X_valid), torch.LongTensor(y_valid))
    ...
    #    dataset_valid = DataLoader(dataset_valid, batch_size=self.batch_size)
        ...
        num_train_optimization_steps = int(self.epoches * len(dataset_train) / 2)
